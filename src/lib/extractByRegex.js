...
export const extractByRegex = (standarizeInput) => {
   ...
   if (binaryResult) [firstOperating, operator, secondOperating] = binaryResult;
   ...
   if (isNaN(firstOperating) || !isFinite(firstOperating)) throw new InvalidInputError();
   if (binaryResult && (isNaN(secondOperating) || !isFinite(secondOperating))) throw new InvalidInputError();
